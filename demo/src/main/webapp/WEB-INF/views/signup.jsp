...
<p> Create your account: </p>
	<spring:url value="/user/register" var="signURL" />
	<form:form class="form-horizontal border border-success"   modelAttribute="usersignform" method="post" action="${signURL}" >
               <div class="form-group">
			    ...
			    <div class="form-group">
			      <label class="control-label col-sm-2" for="LastName">Password: </label>
	  			  <div class="col-sm-3">
				        <form:input type="password" class="form-control" path="password" onkeyup="CheckPasswordStrength(this.value)"/><br>
